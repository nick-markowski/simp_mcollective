[![License](http://img.shields.io/:license-apache-blue.svg)](http://www.apache.org/licenses/LICENSE-2.0.html) [![Build Status](https://travis-ci.org/simp/pupmod-simp-simp_mcollective.svg)](https://travis-ci.org/simp/pupmod-simp-simp_mcollective) [![SIMP compatibility](https://img.shields.io/badge/SIMP%20compatibility-6.*-orange.svg)](https://img.shields.io/badge/SIMP%20compatibility-6.*-orange.svg)

#### Table of Contents

1. [Description](#description)
2. [Setup - The basics of getting started with simp_mcollective](#setup)
    * [What simp_mcollective affects](#what-simp_mcollective-affects)
...
common MCO configurations as supported by the SIMP ecosystem
...
See the [API Documentation](https://github.com/simp/pupmod-simp-simp_mcollective/tree/master/docs/index.html) for full details.
